...
| --- | --- | --- | --- |
| 1-2 | Apresentação da Disciplina, Introdução ao Teste de Software e Qualidade de Software | * Conceitos, histórico, ISO/IEC 25010, Curva de Boehm | 🔄 Em desenvolvimento |
| 3-4 | Conceitos Fundamentais de Teste | * Erro, defeito, falha, incidente, bug, verificação vs validação, SWEBOK, modelos de processo | 🔄 Em desenvolvimento |
